...
// SUPPORTED_EVALUATORS allow-lists in both quasar/pic/io.py and quasar/coil/io.py
// until the loader lands, so a deck cannot select it. The methods fail loudly
// instead of silently returning a zero field, which would look like a
